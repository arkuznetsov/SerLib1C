...
Функция ЭтоТабличнаяЧасть(Значение) Экспорт
	...
	ЧастиТипа = СтрРазделить(ТипДляПроверки);
...
Процедура ТЧОбъектаВСтруктуру(СтруктураОбъекта,
	...
	ОписаниеВидаОбъекта = ПолучитьОписаниеВидаОбъектов(Объект);
	...
	ОписаниеТЧ.Вставить("__Тип" , СтрШаблон("%1ТабличнаяЧасть.%2.%3",
	                                        ...
	                                        МетаОбъект.Имя,
	                                        ИмяТЧ));
	ОписаниеТЧ.Вставить("Имя"   , ИмяТЧ);
	ОписаниеТЧ.Вставить("Строки", МассивСтрок);
	
	СтруктураОбъекта.Вставить(ИмяТЧ, МассивСтрок);
