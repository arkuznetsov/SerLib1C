...
Функция ЗначениеСКДВСтруктуру(Объект)
	...
	ИначеЕсли ТипЗначения = Тип("СвязиПараметровВыбораКомпоновкиДанных") Тогда
		СвязиПараметровВыбораСКДВСтруктуру(Объект);
	ИначеЕсли ТипЗначения = Тип("СвязьПараметраВыбораКомпоновкиДанных") Тогда
		СвязьПараметраВыбораСКДВСтруктуру(Объект);
	ИначеЕсли ТипЗначения = Тип("ПараметрыВыбораКомпоновкиДанных") Тогда
		ПараметрыВыбораСКДВСтруктуру(Объект);
	ИначеЕсли ТипЗначения = Тип("ПараметрВыбораКомпоновкиДанных") Тогда
		ПараметрВыбораСКДВСтруктуру(Объект);
	ИначеЕсли ТипЗначения = Тип("СвязьПоТипуКомпоновкиДанных") Тогда
		СвязьПоТипуСКДВСтруктуру(Объект);
...
Процедура ЗначениеСКДИзСтруктуры(Объект, СтруктураОбъекта)
	...
	ИначеЕсли ТипЗначения = Тип("СвязиПараметровВыбораКомпоновкиДанных") Тогда
		СвязиПараметровВыбораСКДИзСтруктуры(Объект, СтруктураОбъекта);
	ИначеЕсли ТипЗначения = Тип("СвязьПараметраВыбораКомпоновкиДанных") Тогда
		СвязьПараметраВыбораСКДИзСтруктуры(Объект, СтруктураОбъекта);
	ИначеЕсли ТипЗначения = Тип("ПараметрыВыбораКомпоновкиДанных") Тогда
		ПараметрыВыбораСКДИзСтруктуры(Объект, СтруктураОбъекта);
	ИначеЕсли ТипЗначения = Тип("ПараметрВыбораКомпоновкиДанных") Тогда
		ПараметрВыбораСКДИзСтруктуры(Объект, СтруктураОбъекта);
	ИначеЕсли ТипЗначения = Тип("СвязьПоТипуКомпоновкиДанных") Тогда
		СвязьПоТипуСКДИзСтруктуры(Объект, СтруктураОбъекта);
	ИначеЕсли ТипЗначения = Тип("ВариантПользовательскогоПоляВыборКомпоновкиДанных") Тогда
