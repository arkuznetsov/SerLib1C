...
Процедура ОформлениеСКДИзСтруктуры(Объект, СтруктураОбъекта) Экспорт
	...
	ЗначенияПараметровОбъектаСКДИзСтруктуры(Объект, СтруктураОбъекта);
...
Процедура ЗначенияПараметровОбъектаСКДИзСтруктуры(Объект, СтруктураОбъекта) Экспорт
	
	Если НЕ СтруктураОбъекта.Свойство("Элементы") Тогда
		Возврат;
	КонецЕсли;
	
	Для Каждого ТекЭлемент Из СтруктураОбъекта.Элементы Цикл
		Если Объект.ДоступныеПараметры = Неопределено Тогда
			...
			ЗначениеПараметраСКДИзСтруктуры(НовыйЭлемент, ТекЭлемент);
		Иначе	
			ТекПараметр = Объект.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных(ТекЭлемент.Параметр));
			ТекПараметр.Значение = ЗначениеИзСтруктуры(ТекЭлемент.Значение);
			Для Каждого ТекВложенныйЭлемент Из ТекЭлемент.ЗначенияВложенныхПараметров Цикл
				НовыйЭлемент = Объект.ЗначенияВложенныхПараметров.Добавить();
				ЗначениеПараметраСКДИзСтруктуры(НовыйЭлемент, ТекВложенныйЭлемент);
			КонецЦикла;
			Объект.Использование = ТекЭлемент.Использование;
		КонецЕсли;
	КонецЦикла;
