...
Функция СвязьПараметраВыбораСКДВСтруктуру(Объект)
	...
	СтруктураОбъекта.Вставить("ИзменениеЗначения", ПеречислениеСКДВСтроку(Объект.ИзменениеЗначения));
	СтруктураОбъекта.Вставить("Имя"              , Объект.Использование);
	СтруктураОбъекта.Вставить("Поле"             , ЗначениеСКДВСтруктуру(Объект.Поле));
...
Процедура СвязьПараметраВыбораСКДИзСтруктуры(Объект, СтруктураОбъекта)
	...
	Если СтруктураОбъекта.Свойство("ИзменениеЗначения") Тогда
		Объект.ИзменениеЗначения = РежимИзмененияСвязанногоЗначения[СтруктураОбъекта.ИзменениеЗначения];
	КонецЕсли;
...
Функция ПеречислениеСКДВСтроку(Значение)
	...
	Возврат ЗначенияПеречисления.Получить(Значение);
