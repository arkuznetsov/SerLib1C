...
Процедура ЗначенияПараметровОбъектаСКДИзСтруктуры(ОбъектВладелец, Объект, СтруктураОбъекта, ИмяКоллекцииПараметров = "Элементы")
...
Функция ТипДополненияПериодаКомпоновкиДанныхВСтроку(Значение)
	...
	Если СИ.ВерсияПриложения >= "8.3.12.0" Тогда
