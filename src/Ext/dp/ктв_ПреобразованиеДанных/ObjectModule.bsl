...
//
// Параметры:
//  ОписаниеЗначения			- Структура, Число, Строка, Дата, Булево	- Описание значение
//
// Возвращаемое значение:
...
// Процедура поиска значений по структуре описания (шаблон процедуры поиска)
...
Функция ТаблицаЗначенийВСтруктуру(Значение)
КонецФункции

Функция ТаблицаЗначенийИзСтруктуры(СтруктураЗначения)
КонецФункции

Функция ДеревоЗначенийВСтруктуру(Значение)
КонецФункции
